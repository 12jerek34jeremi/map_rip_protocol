...
<br/>
Jeżeli wolisz oglądać niż czytać, to zamiast czytania tego pliku, możesz obejrzeć [tovideo](https://drive.google.com/file/d/1PvOYh8J0ySo46twCzeH_PPeGA3tjFoYE/view?usp=share_link), w którym wyjaśniam jak działa algorytm zastosowany w tym programie oraz jak można program skompilować ze żródeł, uruchomić i jak można go używać.<br/><br/>
